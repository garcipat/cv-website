...
- [x] T070 Perform the quickstart §3 manual browser pass (`npm run dev`) over a level exercising every effect, the layered spot-checks, and the quickstart §4 timed-tile/hazard spot-checks (including the editor preview), confirming no visible or behavioural difference (SC-007).
