...
/**
 * All available themes. Every theme switcher UI (`ThemeSelect.tsx`'s
 * dropdown, the IDE theme's `SidebarSettings.tsx` radio list) renders this
 * list directly — Platformer included, since it is a public theme like any
 * other.
 */
