...
if ($Help) {
    Write-Host "Usage: ./create-new-feature.ps1 [-Json] [-DryRun] [-AllowExistingBranch] [-ShortName <name>] [-FeatureId <id>] [-Number N] [-Timestamp] <feature description>"
    Write-Host ""
    Write-Host "Options:"
    ...
    Write-Host "  -FeatureId <id>     Feature ID to use as prefix (e.g., 'F-008') instead of sequential number"
    ...
    Write-Host ""
    Write-Host "Examples:"
    Write-Host "  ./create-new-feature.ps1 -FeatureId 'F-008' -ShortName 'player-roster' 'Player Roster Display'"
    Write-Host "  ./create-new-feature.ps1 'Add user authentication system' -ShortName 'user-auth'"
    Write-Host "  ./create-new-feature.ps1 -Timestamp -ShortName 'user-auth' 'Add user authentication'"
    Write-Host "  `$env:GIT_BRANCH_NAME = 'my-branch'; ./create-new-feature.ps1 'feature description'"
    exit 0
}
...
if ($env:GIT_BRANCH_NAME) {
    ...
    if ($FeatureId) {
        # Use provided feature ID (e.g., F-008)
        $featureNum = $FeatureId
        $branchName = "$featureNum-$branchSuffix"
    } elseif ($Timestamp -and $Number -ne 0) {
