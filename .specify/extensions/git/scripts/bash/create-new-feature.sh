...
while [ $i -le $# ]; do
    ...
    case "$arg" in
        ...
        --help|-h)
            ...
            echo "  --feature-id <id>   Feature ID to use as prefix (e.g. 'F-008') instead of sequential number"
            ...
            echo ""
            echo "Examples:"
            echo "  $0 'F-008: Player Roster Display' --short-name 'player-roster' --feature-id 'F-008'"
