...
- [x] **O-011** **Platformer Deployable Ladders** — A rolled rope-ladder bundle that unrolls downward on Up until it lands on the next solid tile, then climbs like a ladder
...
- [ ] **O-015** **Platformer Editor Dark Mode** — A dark/light toggle in the Level Editor that renders the cave darkness overlay and the torch light pools while authoring, so an author can see the real lighting without leaving the editor
- [ ] **O-016** **Platformer Editor UI Rework** — A cleanup pass over the Level Editor's UI: regroup and simplify the toolbar and panels as the tool has grown
...
| O-010 | Platformer cave lighting | ✅ Done | [spec](../specs/O-010-platformer-cave-lighting/spec.md) | ✅ | ✅ |
| O-011 | Platformer deployable ladders | ✅ Done | [spec](../specs/O-011-platformer-deployable-ladders/spec.md) | ✅ | ✅ |
...
| O-015 | Platformer editor dark mode | 📋 Planned | — | ❌ | ❌ |
| O-016 | Platformer editor UI rework | 📋 Planned | — | ❌ | ❌ |
