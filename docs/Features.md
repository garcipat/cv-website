...
- [ ] **S-010** **Platformer Hurt Feedback** — Colored hit-debris burst on the character and on enemies for every landed hit, plus a pulsing low-health canvas glow
...
| S-010 | Platformer hurt feedback | 📋 Planned | [spec](../specs/S-010-platformer-hurt-feedback/spec.md) | ❌ | ❌ |
